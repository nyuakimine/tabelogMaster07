...
export const ShoppingMall: React.FC = () => {
  ...
  let newAndRecommendGoodses: any = useSelector(
    (s: RootState) => s.newAndRecommendGoodses.newAndReGoodsesList.data
  );
  ...
  return categories.loading === true ? (
    ...
    <div id="content">
      ...
      <NewGoods data={newAndRecommendGoodses}></NewGoods>
      <RecommendGoodses data={newAndRecommendGoodses}></RecommendGoodses>
    </div>
  );
};
