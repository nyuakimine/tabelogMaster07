      ...
      {topCoupon.map((coupon, idx) => {
        return (
          <div className="rstdtl-rstinfo-coupon " key={idx}>
            <a data-analytics-alliance="" className="rstdtl-rstinfo-coupon__target js-analytics" href={`${topCoupon.couponTarget}`}>
              <div className="rstdtl-rstinfo-coupon__inner">
                <p className="rstdtl-rstinfo-coupon__subject">{topCoupon.couponSubject}</p>
                <p className="rstdtl-rstinfo-coupon__description"> {topCoupon.couponDescription} </p>
                <p className="rstdtl-rstinfo-coupon__btn-wrap">
                  <span className="rstdtl-rstinfo-coupon__btn">{topCoupon.couponBtn}</span>
                </p>
              </div>
            </a>
          </div>
