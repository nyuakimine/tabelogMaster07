...
export const TopImg: React.FC = () => {
    const count = useSelector((state: RootState) => state.leftImg.counter);

    const topImg = useSelector((state: RootState) => state.topNoticeCommentSlice.data);

    const imgLength = useSelector((state: RootState) => state.topImgSlice.data.length);
    console.log("mmmmmmmmmmmmmmmmmmm",imgLength);
        ...
        <div className="bx-wrapper">
          ...
          <div className="bx-controls bx-has-controls-direction">
            <div className="bx-controls-direction">
              <a className="bx-prev" href=""  onClick={() => dispatch(increment(imgLength))}>
                Prev
              </a>
              <a className="bx-next" href=""  onClick={() => dispatch(decrement(imgLength))}>
                Next
              </a>
            </div>
          </div>
