...
export const TopPostphoto: React.FC = () => {
  ...
  const currentBigImage = topPostphoto.filter((num, index) => index === count)
      ...
      <div className="js-imagebox-container p-modal-image is-open" style={{ display: 'none' }}>
        <div className="js-main-view-wrap p-modal-image__main">
          <div className="js-imagebox-navi p-modal-image__nav">
            <a className="js-imagebox-navi-prev p-modal-image__nav-btn-prev" href="#" style={{ display: 'none' }}></a>
            <a className="js-imagebox-navi-next p-modal-image__nav-btn-next" href="#"></a>
          </div>
          <div className="p-modal-image__image">
            <img
              className="js-imagebox-photo p-modal-image__image-photo"
              src="https://tblg.k-img.com/restaurant/images/Rvw/153839/640x640_rect_153839147.jpg"
            />
