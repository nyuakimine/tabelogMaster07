...
export const TopBox1: React.FC = () => {
  const TopBox1 = useSelector((state: RootState) => state.topBasicInformation.data)
  return TopBox1 === null ? (
    <h2>loading...</h2>
  ) : (
    <table className="c-table c-table--form rstinfo-table__table">
      <tbody>
        <tr>
          <th>店名</th>
          <td>{TopBox1.resName}</td>
        </tr>
        <tr>
          <th>ジャンル</th>
          <td>
            <span>{TopBox1.genre}</span>
          </td>
        </tr>
        <tr>
          <th>
          ...
          <td>
            <p className="rstinfo-table__tel-num-wrap">
              <strong className="rstinfo-table__tel-num">{TopBox1.phoneNumber}</strong>
        ...
        <tr>
          <th>予約可否</th>
          <td>
            <p className="rstinfo-table__reserve-status">{TopBox1.reserveStatus}</p>
          </td>
        </tr>
        <tr>
          <th>住所</th>
        ...
        <tr>
          ...
          <td>
            <div className="rstinfo-table__budget">
              <span className="rstinfo-table__budget-item">
                <i>[夜]</i>
                <em className="gly-b-dinner"> {TopBox1.officialBudget}</em>
              </span>
              <span className="rstinfo-table__budget-item">
                <i>[昼]</i>
                <em className="gly-b-lunch">～￥999</em>
        ...
        <tr>
          ...
          <td>
            <p>カード可</p>
            <p className="rstinfo-table__notice"> {TopBox1.payWay}</p>
            <p className="rstinfo-table__each-info"></p>
