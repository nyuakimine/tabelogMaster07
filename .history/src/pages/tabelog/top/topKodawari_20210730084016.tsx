...
export const TopKodawari: React.FC = () => {
  return (
    <div className="rstdtl-top-kodawari">
      ...
      <div className="rstdtl-top-kodawari__item">
        <div className="js-kodawari-cassete rstdtl-top-kodawari__target" data-kodawari-id="1">
          <div className="rstdtl-top-kodawari__contents">
            <p className="rstdtl-top-kodawari__label rstdtl-top-kodawari__label--other">その他 </p>
            ...
            <p className="rstdtl-top-kodawari__title">安心安全の中で忘新年会を楽しもう！ </p>
          </div>
        </div>
