    ...
    <div className="rstdtl-hygiene">
      ...
      <div className="rstinfo-edit-navi">
        <div className="rstdtl-notice u-text-notice">
          ...
          <p>
            Go To Eatキャンペーン参加店舗では、<a href="http://user-help.tabelog.com/sanitations_information">ガイドライン</a>
            に沿った感染症対策遵守に同意しています。
          </p>
          <p>
            <a className="icon-b-arrow-orange js-analytics" href="/support/inquiry?rcd=13019285&amp;type=36">
              内容に誤りがある場合
            </a>
          </p>
        </div>
