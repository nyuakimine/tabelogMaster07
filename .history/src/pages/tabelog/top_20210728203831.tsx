...
export const Top1: React.FC = () => {
  return (
    ...
    <input type="radio" id="rstdtl-extra-info-more" className="rstdtl-extra-info__input"/>
    <labelclassName="rstdtl-extra-info__label">
      <div className="rstdtl-extra-info__text">
        ◆ ご予約は、お一人様 LunchTime 1,000円以上、DinnerTime 3,000円以上とさせて頂きます<br/><br/>◆ スンドゥブフェア 10月20日～ ランチタイム限定 開催 致します～！<br/><br/>◆◇ 吾照里のコロナウィルス感染防止対策<br/><br/>新型コロナウィルス感染拡大防止中<br/>席の間隔､<span>...</span>
      </div>
