    ...
    <div className="rstdtl-extra-info">
      ...
      <label className="rstdtl-extra-info__label">
        <div className="rstdtl-extra-info__text">
          ...
          <br />
          席の間隔､
          <span id="hiddenSpan" onClick={showMoreReviewsBtn}>
            ...
          </span>
        </div>
        <p className="rstdtl-extra-info__more-trigger" id="hiddenSpan" onClick={showMoreReviewsBtn}>
          もっと見る
        </p>
...
// className="rstdtl-extra-info__more-dtl remove-head-space"