...
export const Top: React.FC = () => {
  ...
  </table></div></div></div></div><div className="p-booking-calendar__select-wrap"><div className="p-booking-calendar__select"><p className="p-booking-calendar__select-label">人数</p><div className="p-booking-calendar__select-item"><div className="js-headcount"><div className="js-select-member p-booking-calendar__select-item-inner"><p className="p-booking-calendar__select-target c-select"><select className="js-svps"><option value="1">× 1名</option><option value="2" >× 2名</option><option value="3">× 3名</option><option value="4">× 4名</option><option value="5">× 5名</option><option value="6">× 6名</option><option value="7">× 7名</option><option value="8">× 8名</option><option value="9">× 9名</option><option value="10">× 10名</option><option value="11">× 11名</option><option value="12">× 12名</option><option value="13">× 13名</option><option value="14">× 14名</option><option value="15">× 15名</option><option value="16">× 16名</option><option value="17">× 17名</option><option value="18">× 18名</option><option value="19">× 19名</option><option value="20">× 20名</option><option value="21">× 21名</option><option value="22">× 22名</option><option value="23">× 23名</option><option value="24">× 24名</option><option value="25">× 25名</option><option value="26">× 26名</option><option value="27">× 27名</option><option value="28">× 28名</option><option value="29">× 29名</option><option value="30">× 30名</option><option value="31">× 31名</option><option value="32">× 32名</option><option value="33">× 33名</option><option value="34">× 34名</option><option value="35">× 35名</option><option value="36">× 36名</option><option value="37">× 37名</option><option value="38">× 38名</option><option value="39">× 39名</option><option value="40">× 40名</option><option value="41">× 41名</option><option value="42">× 42名</option><option value="43">× 43名</option><option value="44">× 44名</option><option value="45">× 45名</option><option value="46">× 46名</option><option value="47">× 47名</option><option value="48">× 48名</option><option value="49">× 49名</option><option value="50">× 50名</option><option value="51">× 51名</option><option value="52">× 52名</option><option value="53">× 53名</option><option value="54">× 54名</option><option value="55">× 55名</option><option value="56">× 56名</option><option value="57">× 57名</option><option value="58">× 58名</option><option value="59">× 59名</option><option value="60">× 60名</option><option value="61">× 61名</option><option value="62">× 62名</option><option value="63">× 63名</option><option value="64">× 64名</option><option value="65">× 65名</option><option value="66">× 66名</option><option value="67">× 67名</option><option value="68">× 68名</option><option value="69">× 69名</option><option value="70">× 70名</option><option value="71">× 71名</option><option value="72">× 72名</option><option value="73">× 73名</option><option value="74">× 74名</option><option value="75">× 75名</option><option value="76">× 76名</option><option value="77">× 77名</option><option value="78">× 78名</option><option value="79">× 79名</option><option value="80">× 80名</option><option value="81">× 81名</option><option value="82">× 82名</option><option value="83">× 83名</option><option value="84">× 84名</option><option value="85">× 85名</option><option value="86">× 86名</option><option value="87">× 87名</option><option value="88">× 88名</option><option value="89">× 89名</option><option value="90">× 90名</option><option value="91">× 91名</option><option value="92">× 92名</option><option value="93">× 93名</option><option value="94">× 94名</option><option value="95">× 95名</option><option value="96">× 96名</option><option value="97">× 97名</option><option value="98">× 98名</option><option value="99">× 99名</option></select></p></div></div></div></div><div className="p-booking-calendar__select"><p className="p-booking-calendar__select-label">時間</p><div className="p-booking-calendar__select-item"><div className="js-booking-time"><div className="js-select-time p-booking-calendar__select-item-inner"><p className="p-booking-calendar__select-target c-select"><select className="js-svt"><option value="1900" data-url="">× 19:00</option></select></p></div></div></div></div></div><div className="js-no-vacant-notice p-booking-calendar__attention-wrap is-hidden"><p className="p-booking-calendar__attention">ご指定の条件での空席がありません。別の条件でお探しください。</p></div><div className="js-available-tpoint-notification"></div><div className="p-booking-calendar__btn-wrap"><a className="js-booking-form-open c-btn c-btn--full c-btn--primary" href="#"><span className="js-booking-container-button">予約する</span></a></div></div></div></div></div>
                </div>
              </div>
