...
<div className="rstdtl-extra-info">
          ...
          <label  className="rstdtl-extra-info__label">
            <div className="rstdtl-extra-info__text">
              ◆ ご予約は、お一人様 LunchTime 1,000円以上、DinnerTime 3,000円以上とさせて頂きます<br>◆ スンドゥブフェア 10月20日～ ランチタイム限定 開催 致します～！</br><br>◆◇ 吾照里のコロナウィルス感染防止対策</br><br><br>新型コロナウィルス感染拡大防止中</br></br><br>席の間隔､</br><span>...</span>
            </div>
