...
export const NewBeeMallDetail: React.FC<RouteComponentProps<MatchParams>> =
  () => {
    ...
    const qaList = useSelector((state) => state.qaListSlice.qaData);
    const reviewList = useSelector((state) => state.reviewListSlice.reviewData);
    console.log("descxxxxxxxxxxx", desc);
            ...
            <div id="sizeQAContainer">
              <div id="innerSizeQAContainer">
                ...
                <section className="g-grid_item g-sm-block-sm">
                  <QaNewBeeMall qaData={qaList}></QaNewBeeMall>
                  <ReviewNewBeeMall reviewData={reviewList}></ReviewNewBeeMall>
                </section>
              </div>
            </div>
          </div>
