  ...
  return (
	<div className="zv-cqa-step" id="detailFooter">
					...
					<div id="zv-lightbox">
						<div id="zv-lightbox-header">
							<button id="zv-close-button" type="button"><span
									className="zv-close-icon"></span></button>
						</div>
						<div id="zv-lightbox-body">
							...
							<ul>
								...
								<li>ニトリが不適切と判断した際、後日投稿を削除する場合がございます。詳細はご利用ガイドの<a className="g-link-u"
										href="https://www.nitori-net.jp/ec/userguide/nitorinet/#zv-cqa"
										target="_blank">ニトリ商品Q&amp;Aについて</a>をご確認ください。</li>
							</ul>

							<p className="zv-error-message" id="ZVSpamError">しばらく時間をおいて投稿してください。</p>
							<div id="ZVPostArea"
								data-customerqa-message-after-post-answer="回答ありがとうございます。"
								data-customerqa-message-after-post-comment="コメントありがとうございます。">
								<button type="button" className="zv-btn" id="ZVPostButton">回答</button>
							</div>
							<div id="ZVColseArea" className="zv-hide">
								<button type="button" className="zv-btn" id="ZVColseButton">閉じる</button>
							</div>
						</div>
					</div>
				</div>
				...
				<div id="ZVCQAPost">
					...
					<div className="zv-cqa-posting-rule">
						...
						<ul>
							...
							<input type="textbox" id="ZVQuestionTextarea" className="zv-textbox"
							...
							<div id="ZVAskPostArea"
								...
								<p className="zv-error-message" id="ZVLoginErrorQuestion">質問を投稿するにはログインが必要です。</p>
								<p className="zv-error-message" id="ZVEmptyErrorQuestion">質問を入力してください。</p>
								<p className="zv-error-message" id="ZVSpamErrorQuestion">しばらく時間をおいて投稿してください。</p>
								<button type="button" id="ZVPostQuestionButton" className="zv-btn">質問を投稿</button>
							</div>
						</div>
			...
			<div id="js-replace"><input type="hidden" name="productCodePost" value=""/>
				...
				<p className="g-reviewList_info">購入商品:カジュアルソファ(パトレック GR/MBR）)</p>
				<p className="g-reviewList_user"><b > </b>さん<span
						className="g-clip" >2020/07/20</p>
				...
				<p >
					...
					適度なフカフカさもあります。
					良い買い物出来ました。
					触り心地良いですが、飲み物などこぼしたら、シミになりそうなので、私は色も好きだけど、ソファカバーを店舗で買いました。</p>
				<p className="g-reviewList_like">
					<a className="g-link reviewLike0" id="js-hitLike" data-count="0"
						>
			...
			<li className="g-reviewList_item">
				<div className="g-lg-flow-sm">
					...
					<p className="g-reviewList_user" ><b>ルル</b>さん 2021/03/09</p>
				</div>

										<p className="g-reviewList_info">購入商品:カジュアルソファ(パトレック GR/LBR)</p>
										<p className="g-reviewList_h">可愛い</p>
										<p>コンパクトで色もめっちゃ可愛いです。本当に買って良かったです。
											組み立ても簡単でした。</p>
										<p className="g-reviewList_like"><a className="g-link reviewLike1" id="js-hitLike"
												data-count="1" data-clickable=""><i
													className="g-s g-s-like-g"
													aria-hidden="true"></i><span>参考になった（2人）</span></a></p>
				</li>

								

				</ul>			
				<div id="p-reviewMore" aria-hidden="true">
						...
						<div className="g-foot-v g-foot-sm" id="js-review-more" aria-hidden="false">
							...
							<p className="g-align-tc" id="showMoreReviewsBtn">
								<a className="g-link displaymorereview" href="#p-reviewMore" role="button"
									aria-expanded="false" aria-controls="p-reviewMore" data-label="閉じる"
									data-accordion="{&quot;scroll&quot;:false}">
									<i className="g-i g-i-arrow-d"></i>
									<span id="showMoreLabel">レビューをもっと見る（3/
										<span id="js-reviews-more">4</span>）</span>
								</a>
							</p>
