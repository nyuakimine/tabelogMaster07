...
import { fetchOpenAndCloseDataActionCreator, closeShowList } from '../../redux/OpenCloseReviewSlice/openCloseReviewSlice'
...
export const ReviewNewBeeMall: React.FC<pIf> = () => {
  ...
  const initialList = useSelector((state: RootState) => state.openCloseReviewSlice.initialList)

  const showMoreList = useSelector((state: RootState) => state.openCloseReviewSlice.showMoreList)
  ...
  useEffect(() => {
    if (goodsId != null) {
      dispatch(fetchOpenAndCloseDataActionCreator({ goodsId, 1: 1 }))
    }
  }, [])
  ...
  const helpNumFun = e => {
    ...
    if (flag) {
      dispatch(fetchHelpNumDataActionCreator({ reviewId, goodsId }))
    } else {
      dispatch(fetchHelpNumDataActionCreator({ reviewId, ids, goodsId }))
    }
  }
                    ...
                    <li className="g-reviewList_item">
                      ...
                      <p className="g-reviewList_like">
                        <a className="g-link reviewLike0" id="js-hitLike" data-count="0">
                          ...
                          <span className="helpNumSpan" review-id={reviewList.id} onClick={helpNumFun}>
                            {/* onClick={helpNumFun} */}
        ...
        <div className="g-foot-v g-foot-sm" id="js-review-more" aria-hidden="false">
          <p className="g-align-tc" id="showMoreReviewsBtn">
            ...
            >
              ...
              <span className="closeShowLists" id="showMoreLabel" onClick={showMoreReviewsBtn}>
                レビューをもっと見る
          ...
          <p className="g-align-tc" id="closeBtn">
            <a
              ...
              data-accordion='{"scroll":false}'
            >
              <span className="closeCloseBtn" id="closeLabel" onClick={closeShowMoreReviewsBtn}>
                閉じる
              </span>
            </a>
          </p>
