...
export const ReviewNewBeeMall: React.FC<pIf> = ({ data }) => {
  const reviewLength = useSelector((state) => state.reviewListSlice.data.data.length);
        ...
        >
          <p className="g-align-tc" id="showMoreReviewsBtn">
            ...
            >
              ...
              <span id="showMoreLabel">onClick={() => dispatch(fetchReviewDataActionCreator(reviewLength))}  
                レビューをもっと見る（3/
          ...
          <p className="g-align-tc" id="closeBtn">
            <a
              ...
              data-accordion='{"scroll":false}'
            >
              <span id="closeLabel"> onClick={() => dispatch(fetchReviewDataActionCreator(reviewLength))}       
         閉じる</span>
            </a>
          </p>
        </div>
