  ...
  const closeShowMoreReviewsBtn = (e) => {
   ...
   if(showMoreList) {
    closeClose[0].style.display = "none";
      document.getElementsByClassName('closeCloseBtn')!.style.display='none'
        ...
        >
          <p className="g-align-tc" id="showMoreReviewsBtn">
            ...
            >
              ...
              <span id="showMoreLabel" onClick={showMoreReviewsBtn}>{buttonText}
          ...
          <p className="g-align-tc" id="closeBtn">
            <a
              ...
              data-accordion='{"scroll":false}'
            >
              <span className={showMoreList === null? "closeCloseBtn":undefined} id="closeLabel" onClick={closeShowMoreReviewsBtn}>
