...
export const ReviewNewBeeMall: React.FC<pIf> = () => {
  ...
  let initialList = useSelector((state) => state.openCloseReviewSlice.initialList);
  let showMoreList =useSelector((state) => state.openCloseReviewSlice.showMoreList);
 ...
 // console.log(" e.setStatev", e.setState);
  dispatch(fetchOpenAndCloseDataActionCreator({goodsId :goodsId}));
  dispatch(fetchOpenAndCloseDataActionCreator({ids: ids}))
  //dispatch(fetchOpenAndCloseDataActionCreator(showMoreList));
  }
