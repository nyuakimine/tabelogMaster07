...
export const QaNewBeeMall: React.FC<pIf> = ({data}) => {
  const qaPage = useSelector((state: RootState) => state.qaPageSlice.pagination.length);
        ...
        <div className="zv-cqa">
          <div className="zv-cqa-step">
            <div className="zv-cqa-step-link">
              ...
              <span className="previousPage" onClick={() => dispatch(decrement(qaPage))}>  
              前ページ
       </span>
              <span>全2件</span>
              <span>
              ...
              <span className="nextPage" onClick={() => dispatch(increment(qaPage))}>
              次ページ
       </span>
            </div>
