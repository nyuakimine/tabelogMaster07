...
export const QaNewBeeMall: React.FC<pIf> = ({qaData}) => {

  console.log("xxxxxxQadata", qaData);
  const { goodsId } = useParams<MatchParams>();
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(fetchQaDataActionCreator(goodsId));
  }, []);
  return qaData === undefined ? (
    <h2>loading...</h2>
  ) :  (
        ...
        <div className="zv-cqa">
          ...
          <div className="zv-cqa delete" key={idx}>
            ...
            <div className="zv-cqa-q-info">
              ...
              <span className="zv-cqa-step">{qaList.submitDate}投稿日&nbsp;2021年04月02日</span>
            </div>
