...
import { decrement, increment} from "../../redux/qaPageSlice/fetchQaPagingSlice";
        ...
        <div className="zv-cqa">
          <div className="zv-cqa-step">
            <div className="zv-cqa-step-link">
              ...
              <span className="previousPage" onClick={() => dispatch(decrement(data))}>  
              前ページ
       </span>
              <span>全2件</span>
              <span>
              ...
              <span className="nextPage" onClick={() => dispatch(increment(data))}>
              次ページ
       </span>
            </div>
